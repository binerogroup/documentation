...
Backup
======
Using the backup feature in Binero.Cloud, you are able to backup and restore volumes. Backups will be stored on the object storage of your account in :doc:`availability zone </storage/regions-and-availability-zones>` **europe-se-1b** using the gp.archive :doc:`flavor </storage/object-storage/flavors>`. 
...
.. Tip::
	We strongly recommend doing a restore-test of your backups. Since :doc:`restoring <restore-volume>` to a new volume and creating a new instance that could run parallel to the real one is very easy, this is a good way to ensure data consistency in your backup.
