==========================
Launching a virtual router
==========================
To create a virtual router in Binero.cloud, you have four main options as outlined in the links below. Each option have its pros and cons:
