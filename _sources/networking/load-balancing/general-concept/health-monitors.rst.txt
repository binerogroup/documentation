...
A monitor is defined per listener. We recommend ensuring that the monitor is as closely matched to the listener type as possible. If you are for instance using load balancing for an http based service, don't do health checking by pinging the members. This will have almost no bearing on whether the individual members are working or not and will probably cause faulty members to remain in production.
