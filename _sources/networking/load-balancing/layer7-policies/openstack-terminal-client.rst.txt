...
.. Note::
	Above is an example of a rule which would perform a redirect. More information on the available rules can be read in detail `here <https://docs.openstack.org/python-octaviaclient/latest/cli/index.html#l7policy>`__.