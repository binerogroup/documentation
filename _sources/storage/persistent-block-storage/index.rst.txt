...
Binero cloud will not provision an instance without a volume attached and the smallest volume size
allowed is the size of the :doc:`image </images/index>` or disk specified in the :doc:`flavor </compute/flavors>`.
