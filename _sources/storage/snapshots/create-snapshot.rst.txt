...
.. Important::
	For data integrity reasons, we recommend shutting of an instance before snapshotting its volumes. Incomplete writes might otherwise impact data-integrity (of the snapshot, not the volume). It is however possible to snapshot instances that are running.
