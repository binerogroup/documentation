...
.. Note::
        The cron format might be difficult to understand. When your snapshot job is created, if you press it, you can find out the "cron pattern". There are several websites that can translate the cron pattern to a textual representation. Doing a web search for "cron pattern" might yield various options.
