...
- Under "private_net_name", select the :doc:`network </networking/virtual-router/private-network/index>` on which the private subnet (see below) that you want to use is located.
- Under "private_subnet_name", select the :doc:`network </networking/virtual-router/private-subnet/index>` on which you want to run the service.
