...
.. tip::
   ...
   We recommend, therefore, to choose a range that is less likely to be overlapping other subnets.
...
.. tip::
   ...
   multiple addresses) then maybe aim for a subnet with a /23 mas that would give you 510 usable addresses.
