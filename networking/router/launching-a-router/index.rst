...
- :doc:`The OpenStack terminal client <openstack-terminal-client>` is a command line implementation giving terminal oriented users a (very) quick way to access the cloud. The learning curve is steeper than the GUI implementation but the workflow will be very efficient.
...
.. note:: In order to create your router, you will first need to know in what :doc:`availability zone  </networking/regions-and-availability-zones>` to create it.
