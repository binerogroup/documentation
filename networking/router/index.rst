...
router are `directly connected internet access </networking/directly-attached-ips>`__.

To a router you connect `private networks </networking/router/private-network/index>`__ on which
you define `private subnets </networking/router/private-subnet/index>`_ that your instances connect
to. Using a router enables (among other things):

- :doc:`private-subnet/index`

- :doc:`routing-between-networks`

- :doc:`Security groups (firewall) <security-groups/index>`
