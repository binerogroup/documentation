...
.. Note::
	Backups are just for volumes. You are not able to backup an image. The image, however, is just meta-data about how your instance was configured and is easily replaced by just mimicking the same settings when :doc:`creating an instance from a volume <../persistent-block-storage/creating-an-instance-from-a-volume>`.
