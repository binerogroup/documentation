...
You can only create an :ref:`EC2 credential <ec2-credentials-label>` using the
...
You can read more about :ref:`ec2-credentials-label` in our :doc:`/getting-started/users` documentation.
