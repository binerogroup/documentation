...
``q35`` on your :doc:`image </images/index>` or in the volume image metadata.

The system copies the image properties into the volume image metadata when it creates
